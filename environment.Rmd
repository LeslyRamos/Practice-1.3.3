---
title: 'Practice 1.3: R Class'
---## Working directory problem

```{r eval=TRUE, message=FALSE, warning=FALSE, include=FALSE, purl=F, results="hide"}
...
<iframe width="100%" height="300" src="https://rdrr.io/snippets/embed/?code=rep(%22This%20is%20R%22%2C%2050)" frameborder="0" data-external="1">
...
**DO NOT INSTALL R OR LATER SOFTWARES ON YOUR DESKTOP. ACCEPT DEFAULT OTHERWISE I WILL NOT BE ABLE TO HELP YOU**
...
If you already have R on your computer, an alternative is to run the following line of code in R native GUI ([it will tell you if your R version is out-of-date ]{style="color: red"}):
